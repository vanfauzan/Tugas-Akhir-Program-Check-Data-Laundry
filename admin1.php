...
<head>
	<title>Halaman Data Admin 1</title>
</head>

<body>
<h1>Admin 1</h1>
<h2>Data Check Laundry</h2>
<a href="inputdata1.php" style="padding:0.4% 0.8%;background-color:#fff;border-radius:2px;text-decoration:none;">Penambahan Data</a> <br><br>
<table border="1" cellspacing="0" width="50%">
	...
	<tr style="text-align:center;">
		...
		<td>
			<a href="editdata1.php?waktu=<?php echo $hasil['waktu'] ?>">Edit</a>
			<br>
			<a href="hapusdata1.php?waktu=<?php echo $hasil['waktu'] ?>">Hapus</a>
		</td>	
	</tr>
